...
const textareaTheme = {
  ...
  colors: {
    gray: 'bg-white border-gray-200 text-gray-900 focus:border-gray-500 focus:ring-gray-500 dark:border-gray-700 dark:bg-gray-800 dark:text-white dark:placeholder-gray-400 dark:focus:border-gray-500 dark:focus:ring-gray-500',
